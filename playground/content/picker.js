window.PersoPicker = (() => {
  ...
  function isPersoNode(node) {
    return Boolean(
      ...
      node?.closest?.("#perso-xxl-panel, #perso-xxl-picker-overlay, [data-perso-xxl-ui], .ai-input, .ai-sent-list, .preview-stack, .mod-focus-stack, .productivity-ai-wrap, .productivity-toast")
    );
  }
